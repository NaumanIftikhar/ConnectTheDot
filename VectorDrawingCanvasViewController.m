//
//  VectorDrawingCanvasViewController.m
//  ConnectTheDots
//
...
@implementation VectorDrawingCanvasViewController
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if (DotImage1 && DotImage2) {
        ...
        [HorizontalLine1 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage2 && DotImage3){
        
        [HorizontalLine2 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage3 && DotImage4){
        
        [HorizontalLine3 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage4 && DotImage5){
        
        [HorizontalLine4 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage5 && DotImage10){
        
        [VerticalLine3 setImage:[UIImage imageNamed:@"gold strip 19Aug.png"]];
    }
    if (DotImage10 && DotImage15){
        
        [VerticalLine4 setImage:[UIImage imageNamed:@"gold strip 19Aug.png"]];
    }
    if (DotImage1 && DotImage6){
        
        [VerticalLine1 setImage:[UIImage imageNamed:@"gold strip 19Aug.png"]];
    }
    if (DotImage6 && DotImage11){
        
        [VerticalLine2 setImage:[UIImage imageNamed:@"gold strip 19Aug.png"]];
    }
    if (DotImage15 && DotImage8){
        
        [DiagonalLine1 setImage:[UIImage imageNamed:@"left gold striip diagonal 18Aug.png"]];
    }
    if (DotImage8 && DotImage11){
        
        [DiagonalLine2 setImage:[UIImage imageNamed:@"right gold strip diagonal 18Aug.png"]];
    }
    if (DotImage6 && DotImage7) {
        [HorizontalLine9 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage7 && DotImage8) {
        [HorizontalLine10 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage8 && DotImage9) {
        [HorizontalLine11 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage9 && DotImage10) {
        [HorizontalLine12 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage7 && DotImage8) {
        [HorizontalLine10 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage2 && DotImage7) {
        [VerticalLine5 setImage:[UIImage imageNamed:@"gold strip 19Aug.png"]];
    }
    if (DotImage7 && DotImage12) {
        [VerticalLine6 setImage:[UIImage imageNamed:@"gold strip 19Aug.png"]];
    }
    if (DotImage3 && DotImage8) {
        //[VerticalLine7 setImage:[UIImage imageNamed:@"red vertical line 2 18Aug.png"]];
    }
    if (DotImage8 && DotImage13) {
        [VerticalLine8 setImage:[UIImage imageNamed:@"gold strip 19Aug.png"]];
    }
    if (DotImage4 && DotImage9) {
        [VerticalLine9 setImage:[UIImage imageNamed:@"gold strip 19Aug.png"]];
    }
    if (DotImage9 && DotImage14) {
        [VerticalLine10 setImage:[UIImage imageNamed:@"gold strip 19Aug.png"]];
    }
    
    if (DotImage11 && DotImage12) {
        [HorizontalLine5 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage12 && DotImage13) {
        [HorizontalLine6 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage13 && DotImage14) {
        [HorizontalLine7 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
    if (DotImage14 && DotImage15) {
        [HorizontalLine8 setImage:[UIImage imageNamed:@"horizontal gold strip 19Aug.png"]];
    }
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if ( dotImage8.tag != 8 || dotImage11.tag != 11  || dotImage15.tag != 15   ) {
...
-(void)InvalidMove{
    ...
    alert = [[UIAlertView alloc] initWithTitle:@"WARNING" message:@"INVALID MOVE" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:nil, nil];
    [alert show];
    drawImage.image = nil;
...
-(void)PlayVideo{
    ...
    //-----------------V I D E O-------------------
        ...
        NSString *moviePath = [bundle pathForResource:@"White_Marlboro" ofType:@"mp4"];
    ...
    //    [holdingView addSubview:self.moviePlayer.view  ];//Embeded video
        [self.view insertSubview:self.moviePlayer.view atIndex:50];//Embeded video
